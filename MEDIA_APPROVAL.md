...
## 18 September 2026 — generated artwork authorization

- [x] User explicitly requested Imagegen artwork for this website.
- [x] public/images/generated/orange-burger-art-v1.png inspected and integrated as conceptual hero artwork; no people, logo reinterpretation or actual menu claim.
- [x] Original generated bytes/provenance retained. Hash, authorization and dimensions registered under manifest.generated; bilingual visible AI caption and alt text.
- [x] Built-in image_gen used. Exact prompt recorded in IMAGEGEN_ART_DIRECTION.md. This is separate from the business-owned Instagram logo authorization.
